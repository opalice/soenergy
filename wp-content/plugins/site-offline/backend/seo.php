...
<table class="form-table">
	...
	<tr class="radio-span" >
		<td>
				<textarea rows="6"  class="pro_text" id="sahu_so_seo_analytiso" name="sahu_so_seo_analytiso" placeholder="<?php _e('Enter Your Google Analytics Script Here','SAHU_SO_TEXT_DOMAIN'); ?>"><?php echo $sahu_so_seo['sahu_so_seo_analytiso']; ?></textarea>
