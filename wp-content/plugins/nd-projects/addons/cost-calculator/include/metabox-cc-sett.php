        ...
        <div class="nd_cc_id_metabox_cpt_content">
            <div id="nd_cc_tab_main">
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    ...
                    <p><input class="nd_cc_width_100_percentage" type="text" name="nd_cc_meta_box_cc_color" id="nd_cc_meta_box_cc_color" value="<?php echo $nd_cc_meta_box_cc_color ?>" /></p>
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    ...
                    <p><input class="nd_cc_width_100_percentage" type="number" name="nd_cc_meta_box_cc_section_number" id="nd_cc_meta_box_cc_section_number" value="<?php echo $nd_cc_meta_box_cc_section_number ?>" /></p>
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    ...
                    <p><input class="nd_cc_width_100_percentage" type="number" name="nd_cc_meta_box_cc_subsection_number" id="nd_cc_meta_box_cc_subsection_number" value="<?php echo $nd_cc_meta_box_cc_subsection_number ?>" /></p>
                ...
                <div class="nd_cc_section nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    ...
                    <p><input class="nd_cc_width_100_percentage" type="number" name="nd_cc_meta_box_cc_repeater_number" id="nd_cc_meta_box_cc_repeater_number" value="<?php echo $nd_cc_meta_box_cc_repeater_number ?>" /></p>
            ...
            <div id="nd_cc_tab_price">
                ...
                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    ...
                    <p><input class="nd_cc_width_100_percentage" type="text" name="nd_cc_meta_box_cc_price_title" id="nd_cc_meta_box_cc_price_title" value="<?php echo $nd_cc_meta_box_cc_price_title ?>" /></p>
                    <p><?php _e('Set the tile for your price section','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php _e('Description','nd-projects'); ?></strong></p>
                    <p><input class="nd_cc_width_100_percentage" type="text" name="nd_cc_meta_box_cc_price_descr" id="nd_cc_meta_box_cc_price_descr" value="<?php echo $nd_cc_meta_box_cc_price_descr ?>" /></p>
                    <p><?php _e('Set the description for your price section','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php _e('Start Price','nd-projects'); ?></strong></p>
                    <p><input class="nd_cc_width_100_percentage" type="text" name="nd_cc_meta_box_cc_price_price" id="nd_cc_meta_box_cc_price_price" value="<?php echo $nd_cc_meta_box_cc_price_price ?>" /></p>
                    <p><?php _e('Set the starting price of your cost calculator','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_border_bottom_1_solid_eee nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php _e('Currency','nd-projects'); ?></strong></p>
                    <p><input class="nd_cc_width_100_percentage" type="text" name="nd_cc_meta_box_cc_price_currency" id="nd_cc_meta_box_cc_price_currency" value="<?php echo $nd_cc_meta_box_cc_price_currency ?>" /></p>
                    <p><?php _e('Insert the currency of your cost calculator','nd-projects'); ?></p>
                </div>

                <div class="nd_cc_section nd_cc_padding_10 nd_cc_box_sizing_border_box">
                    <p><strong><?php _e('Icon','nd-projects'); ?></strong></p>
                    <p><input class="nd_cc_width_100_percentage" type="text" name="nd_cc_meta_box_cc_price_icon" id="nd_cc_meta_box_cc_price_icon" value="<?php echo $nd_cc_meta_box_cc_price_icon ?>" /></p>
