      ...
      <div id="nd_cc_section_'.$nd_cc_section_i.'" class="nd_cc_section_content '.$nd_cc_section_style_class.' ">
        ...
        <div class="nd_cc_section_fields_content">
          ...
          <div style="width:33%; display: inline-block;">
            ...
            <p><input class="regular-text" type="text" name="'.$nd_cc_section_var_name.'" id="'.$nd_cc_section_var_name.'" value="'.$nd_cc_section_name.'" /></p>
          </div>

          <div style="width:33%; display: inline-block;">
            <p><strong>Description :</strong></p>
            <p><input class="regular-text" type="text" name="'.$nd_cc_section_var_descr.'" id="'.$nd_cc_section_var_descr.'" value="'.$nd_cc_section_descr.'" /></p>
          </div>
        ...
        while ( $nd_cc_sub_section_i <= $nd_cc_max_sub_sections ) {
          ...
          <div class="nd_cc_sub_section_fields_content">
            ...
            <div style="width:33%; display: inline-block;">
              <p><strong>Name :</strong></p>
              <p><input class="regular-text" type="text" name="'.$nd_cc_sub_section_var_name.'" id="'.$nd_cc_sub_section_var_name.'" value="'.$nd_cc_sub_section_name.'" /></p>
            </div>
          ...
          <div id="nd_cc_sub_sections_tabs_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'" class="nd_cc_sub_sections_tabs">
            ...
            <div id="tab-1">
              ...
              <div style="width:33%; display: inline-block;">
                ...
                <p style="margin-top:10px;"><input class="regular-text" type="text" name="'.$nd_cc_sub_section_var_slide_min.'" id="'.$nd_cc_sub_section_var_slide_min.'" value="'.$nd_cc_sub_section_slide_min.'" /></p>
              </div>

              <div style="width:33%; display: inline-block;">
                <p><strong>Max :</strong></p>
                <p style="margin-top:10px;"><input class="regular-text" type="text" name="'.$nd_cc_sub_section_var_slide_max.'" id="'.$nd_cc_sub_section_var_slide_max.'" value="'.$nd_cc_sub_section_slide_max.'" /></p>
              </div>

              <div style="width:33%; display: inline-block;">
                <p><strong>Default :</strong></p>
                <p style="margin-top:10px;"><input class="regular-text" type="text" name="'.$nd_cc_sub_section_var_slide_default.'" id="'.$nd_cc_sub_section_var_slide_default.'" value="'.$nd_cc_sub_section_slide_default.'" /></p>
              </div>

              <div style="width:33%; display: inline-block;">
                <p style="margin-top:20px;"><strong>Price</strong></p>
                <p style="margin-top:10px;"><input class="regular-text" type="number" name="nd_cc_sub_section_price_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'_0" id="nd_cc_sub_section_price_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'_0" value="'.get_post_meta( get_the_ID(), 'nd_cc_sub_section_price_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'_0', true ).'" /></p>
              </div>
            ...
            <div id="tab-2">
              ...
              <div style="width:33%; display: inline-block;">
                ...
                <p style="margin-top:10px;"><input class="regular-text" type="text" name="'.$nd_cc_sub_section_var_switch_on.'" id="'.$nd_cc_sub_section_var_switch_on.'" value="'.$nd_cc_sub_section_switch_on.'" /></p>
              </div>

              <div style="width:33%; display: inline-block;">
                <p><strong>Name Off :</strong></p>
                <p style="margin-top:10px;"><input class="regular-text" type="text" name="'.$nd_cc_sub_section_var_switch_off.'" id="'.$nd_cc_sub_section_var_switch_off.'" value="'.$nd_cc_sub_section_switch_off.'" /></p>
              </div>

              <div style="width:33%; display: inline-block;">
                <p><strong>Price</strong></p>
                <p style="margin-top:10px;"><input class="regular-text" type="number" name="nd_cc_sub_section_price_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'_1" id="nd_cc_sub_section_price_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'_1" value="'.get_post_meta( get_the_ID(), 'nd_cc_sub_section_price_'.$nd_cc_section_i.'_'.$nd_cc_sub_section_i.'_1', true ).'" /></p>
              </div>
          ...
          <p><input class="regular-text" readonly type="hidden" name="'.$nd_cc_sub_section_var_active.'" id="'.$nd_cc_sub_section_var_active.'" value="'.$nd_cc_sub_section_active.'" /></p>
